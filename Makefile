...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Thu Jul 13 06:35:32 2017
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -D_FILE_OFFSET_BITS=64 -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /home/spunkybd/bacoin/src/leveldb/libleveldb.a /home/spunkybd/bacoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/spunkybd/bacoin/src/leveldb/libleveldb.a; cd /home/spunkybd/bacoin/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/spunkybd/bacoin/src/leveldb/libleveldb.a: FORCE
	cd /home/spunkybd/bacoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/spunkybd/bacoin/build/build.h: FORCE
	cd /home/spunkybd/bacoin; /bin/sh share/genbuild.sh /home/spunkybd/bacoin/build/build.h
...
build/rpcmining.o: src/rpcmining.cpp src/qt/main.h \
		src/bignum.h \
		src/util.h \
		src/uint256.h \
		src/netbase.h \
...
build/rpcblockchain.o: src/rpcblockchain.cpp src/qt/main.h \
		src/bignum.h \
		src/util.h \
		src/uint256.h \
		src/netbase.h \
