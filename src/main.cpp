...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 555555); // Bacoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302005; // Bacoin: 3.5 days
static const int64 nTargetSpacing = 25; // Bacoin: 2.5 minutes
