...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Wed Jul 12 18:08:43 2017
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /root/bacoin/src/leveldb/libleveldb.a /root/bacoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /root/bacoin/src/leveldb/libleveldb.a; cd /root/bacoin/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/root/bacoin/src/leveldb/libleveldb.a: FORCE
	cd /root/bacoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/root/bacoin/build/build.h: FORCE
	cd /root/bacoin; /bin/sh share/genbuild.sh /root/bacoin/build/build.h
